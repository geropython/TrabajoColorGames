...
public class Diploma4Scripts : MonoBehaviour
{
    ...
    public void DiplomaClose() { _diploma.SetActive(false); }
    public void DiplomaOpen() { _diploma.SetActive(true); }
    ...
    public void DownloadDiploma()
    {
        ...
        string downloadPath = Path.Combine(Application.persistentDataPath, "Diploma4.png");
        if (!string.IsNullOrEmpty(_filePath) && File.Exists(_filePath))
        {
