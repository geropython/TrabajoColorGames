...
public class Diploma4Scripts : MonoBehaviour
{
    ...
    public void ShareDiploma()
    {
        ...
        Texture2D diplomaTexture = Resources.Load<Texture2D>("Diploma4"); // Nombre sin extensión

        if (diplomaTexture != null)
        {
            // Convertir la textura a bytes PNG y guardarla temporalmente
            string filePath = Path.Combine(Application.temporaryCachePath, "Diploma4.png");
