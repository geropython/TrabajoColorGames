...
public class Diploma4Scripts : MonoBehaviour
{
    ...
    {   // Cargar la imagen del diploma desde Resources y guardarla temporalmente
        Texture2D diplomaTexture = Resources.Load<Texture2D>("Diploma4");
        if (diplomaTexture != null)
        {
            ...
            _filePath = Path.Combine(Application.temporaryCachePath, "Diploma4.png");
    ...
    public void DownloadDiploma()
    {
        string downloadPath;
            ...
            downloadPath = Path.Combine("/storage/emulated/0/Download", "Diploma4.png");
        #else
            //Ruta de descarga en otras plataformas (ej., iOS)
            downloadPath = Path.Combine(Application.persistentDataPath, "Diploma4.png");
        #endif
